...
/// <summary>
/// PostgreSQL репозиторий для таблицы WalletSettings
/// Schema:
...
///   );
/// </summary>
public class WalletSettingsRepository(ILogger<WalletSettingsRepository> _logger, PostgreSQLSettings _settings) : IWalletSettingsRepository
{
    ...
    public async Task<CopyTradeWalletSettings?> Get(Wallet wallet)
    {
        ...
        try
        {
            ...
            {
                var valueUsd = reader.GetDecimal(reader.GetOrdinal("ValueUsd"));
                var copyKoef = reader.GetDecimal(reader.GetOrdinal("CopyKoef"));
